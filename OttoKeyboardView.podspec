#
#  Be sure to run `pod spec lint OttoKeyboardView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
       A custom keyboardView on iOS.I hope this can help to you.
                   DESC
  ...
  s.source       = { :git => "https://github.com/WuOtto/OttoKeyboardView.git", :tag => "#{s.version}" }
